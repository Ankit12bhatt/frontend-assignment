...
export const LeaveManagementSection = ({ leaveTypes, leaveRequests, appliedLeaveRefetch }: LeaveManagementSectionProps) => {
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <LeaveRequestForm leaveTypes={leaveTypes}  appliedLeaveRefetch={appliedLeaveRefetch} />
      </div>
